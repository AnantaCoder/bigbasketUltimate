...
class CategoryAdmin(admin.ModelAdmin):
    list_display = ("name", "is_active", "discount", "created_at", "image_preview")
    search_fields = ("name", "description", "popular_brands")
    list_filter = ("is_active",)
    inlines = [ItemInline]
    readonly_fields = ("image_preview","created_at")
    fieldsets = (
        (None, {"fields": ("name", "description", "is_active", "discount")}),
        ("Appearance", {"fields": ("image", "icon", "color", "popular_brands")}),
...
class ItemAdmin(admin.ModelAdmin):
    list_display = ("item_name", "manufacturer", "seller", "category", "price", "quantity", "is_active", "sku", "created_at", "image_preview")
    ...
    fieldsets = (
        (None, {"fields": ("item_name", "item_type", "manufacturer", "seller", "category", "sku")}),
